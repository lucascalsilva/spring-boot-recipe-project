...
create table ingredient (id bigint not null auto_increment, description longtext, quantity decimal(19,2), recipe_id bigint, unit_of_measure_id bigint, primary key (id)) engine=InnoDB;
